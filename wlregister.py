...
TypeEvents = [
    "LOW.SIG", "MDL.SIG", "HIGH.SIG",  # Common signal
    "ATTK.STA", "ATTK.COL", "RED.SIG", # War/battle
    "CRIM.SIG", "PIR.SIG", "CONB.SIG", # Crime signals
    "UNCAT.SIG", "ALIE.SIG", "&!@%)$&" # Mysterious signals
    ]
